...
{
    internal static class magInjector
    {
        ...
        */
        ...
        public static void Inject()
        {
            ...
            {
                Log.Error("Magazines :: Magazine injector failed to get injected");
            }
        ...
        {
            bool enabled = true;
            bool simplifiedAmmo = false;

            // Initialize list of all weapons
            NEW_CE_Utility.allWeaponDefs.Clear();
            ...
            foreach (ThingDef def in DefDatabase<ThingDef>.AllDefsListForReading)
            {
                if (def.IsWeapon
                    ...
                    NEW_CE_Utility.allWeaponDefs.Add(def);
            }
            if (NEW_CE_Utility.allWeaponDefs.NullOrEmpty())
            {
            ...
            foreach (ThingDef weaponDef in NEW_CE_Utility.allWeaponDefs)
            {
                CompProperties_MagazineUser props = weaponDef.GetCompProperties<CompProperties_MagazineUser>();
            ...
            */
            ...
            {
                //AFTER NEW_CE_Utility.allWeaponDefs is initiated, this sets each ammo to list its users & special effects in its DEF DESCRIPTION rather than its THING DESCRIPTION.
                ...
                if (ammoDef.tradeTags != null)
                {
                    ...
                    if (craftingTags.Any())
                    {
                        ...
                        if (recipe == null)
                        {
                            Log.Error("Magazines ammo injector found no recipe named Make" + ammoDef.defName);
                        }
                        else
                        {
        ...
        public static void AddRemoveCaliberFromGunRecipes()
        {
            ...
            {
                NEW_CE_Utility.allWeaponDefs.ForEach(x =>
                {
